...
public static class UserTestData
{
    ...
    private static Faker<AddressGeolocation> addressGeolocationFaker = new Faker<AddressGeolocation>()
    .RuleFor(a => a.Lat, f => f.Address.Latitude().ToString())
    .RuleFor(a => a.Long, f => f.Address.Longitude().ToString());

    private static Faker<UserAddress> userAddressFaker = new Faker<UserAddress>("pt_BR")
    ...
    private static readonly Faker<User> UserFaker = new Faker<User>()
        ...
        .RuleFor(u => u.Name, f => userNameFaker.Generate())
        .RuleFor(u => u.Address, f => userAddressFaker.Generate());
    ...
    {
        return userNameFaker.Generate();
    }

    public static UserName GenerateFirstNameWithMoreThan50characters()
    {
        var faker = new Faker();

        return new UserName()
        {
            FirstName = faker.Random.String(51, 70),
            LastName = faker.Random.String(1, 50)
        };
    }

    public static UserName GenerateEmptyFirstName()
    {
        var faker = new Faker();

        return new UserName()
        {
            FirstName = faker.Random.String(51),
            LastName = faker.Random.String(1, 50)
        };
    }

    public static UserName GenerateLastNameWithMoreThan50characters()
    {
        var faker = new Faker();

        return new UserName()
        {
            FirstName = faker.Random.String(1, 50),
            LastName = faker.Random.String(51, 70)
        };
    }

    public static UserName GenerateEmptyLastName()
    {
        var faker = new Faker();
        ...
        {
            FirstName = faker.Random.String(1, 50),
            LastName = faker.Random.String(51)
        };
    }
